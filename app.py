...
def makeWebhookResult(req):
    ...
    query_result = google_places.nearby_search(location='London, England', lat_lng ={'lat':51.509865, 'lng':-0.118092}, keyword='Fish and Chips',radius=20000, types=[types.TYPE_FOOD])
